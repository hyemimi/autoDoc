...
export const CURRENT_YEAR = String(CURRENT_DATE.getFullYear()); // 현재 년도
export let currentMonth = String(CURRENT_DATE.getMonth() + 1); // 현재 월
currentMonth = Number(currentMonth) >= 10 ? currentMonth : '0' + currentMonth; // 두 자리 표현
export let currentDay = String(CURRENT_DATE.getDate());
